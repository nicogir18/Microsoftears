...
public final class DTOAideAuDesign extends DTOElement {
    ...
    public DTOAideAuDesign(Mesure largeur, Mesure hauteur, Mesure positionX, Mesure positionY, boolean selection){
        _largeur = largeur;
        _hauteur = hauteur;
