...
import ca.ulaval.glo2004.domaine.planRoulotte.Factory.DTOAideAuDesign;
...
public class AideAuDesign extends ElementSelectionnable implements Serializable {
    ...
    public AideAuDesign(Mesure largeur, Mesure hauteur, Point2D position, Panneau panneau) {
        super(false, true);
    ...
    @Override
    public DTOAideAuDesign getElementDTO() {
        return new DTOAideAuDesign(largeur, hauteur, positionX, positionY, selectionStatus);
    }
    ...
    @Override
    public TypeElement getType() {return TypeElement.AIDEAUDESIGN;}
